...
std::map<std::string, Shader>    resourceManagerClass::Shaders;
std::map<std::string, textureClass>    resourceManagerClass::Textures;
...
Shader resourceManagerClass::GetShader(std::string name)
{
	return Shaders[name];
}
...
textureClass resourceManagerClass::GetTexture(std::string name)
{
	return Textures[name];
}

void resourceManagerClass::Clear()
{
...
textureClass resourceManagerClass::loadTextureFromFile(const GLchar *file, GLboolean alpha)
{
